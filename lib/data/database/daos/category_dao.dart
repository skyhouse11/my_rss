...
class CategoryDao extends DatabaseAccessor<AppDatabase>
  ...
  Future<void> createCategory(String name) async {
    await into(categoryTable).insert(CategoryTableCompanion.insert(name: name));
  }

  Future<void> addCategoryToFeed(String feedId, String categoryId) async {
    await into(feedCategories).insert(
  ...
  Future<void> removeCategoryFromFeed(String feedId, String categoryId) async {
    await (delete(feedCategories)..where(
          (t) => t.feedId.equals(feedId) & t.categoryId.equals(categoryId),
        ))
        .go();
  }
  ...
  Future<CategoryTableData?> findByName(String name) async => (select(
    categoryTable,
